...
class EmployeeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteAllEmployees = channel.unary_unary(
                '/employee_service.EmployeeService/DeleteAllEmployees',
                request_serializer=EmployeeService__pb2.EmptyMessage.SerializeToString,
                response_deserializer=EmployeeService__pb2.StatusReply.FromString,
                )
        self.SortEmployees = channel.unary_unary(
                '/employee_service.EmployeeService/SortEmployees',
                request_serializer=EmployeeService__pb2.EmptyMessage.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeDataList.FromString,
                )
...
def add_EmployeeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeleteAllEmployees': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteAllEmployees,
                    request_deserializer=EmployeeService__pb2.EmptyMessage.FromString,
                    response_serializer=EmployeeService__pb2.StatusReply.SerializeToString,
            ),
            'SortEmployees': grpc.unary_unary_rpc_method_handler(
                    servicer.SortEmployees,
                    request_deserializer=EmployeeService__pb2.EmptyMessage.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeDataList.SerializeToString,
            ),
    }
...
class EmployeeService(object):
    ...
    def DeleteAllEmployees(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/DeleteAllEmployees',
            EmployeeService__pb2.EmptyMessage.SerializeToString,
            EmployeeService__pb2.StatusReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SortEmployees(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/SortEmployees',
            EmployeeService__pb2.EmptyMessage.SerializeToString,
            EmployeeService__pb2.EmployeeDataList.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
                                                                                                                                                                                            271,1         Bot                                                                                                                                                                                            230,1         84%                                                                                                                                                                                            155,1         65%                                                                                                                                                                                            129,1         51%                                                                                                                                                                                            89,1          36%                                                                                                                                                                                            48,1          18%                                                                                                                                                                                            1,1           Top
